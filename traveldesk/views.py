...
from .models import vehicle,driver_details,vehicle_bookings
...
def traveldesk_home(request):
	...
	if(driver_details.objects.all().count()==0):
		driver_details.objects.create(driver_name='ram',driver_phonenumber='9542856767',driver_age='22',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='laxman',driver_phonenumber='9542456789',driver_age='32',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='sudheer',driver_phonenumber='9542688790',driver_age='20',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='pavan',driver_phonenumber='9542854565',driver_age='27',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='santhi',driver_phonenumber='9542345678',driver_age='28',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='raju',driver_phonenumber='9542567889',driver_age='29',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='ramu',driver_phonenumber='9542000000',driver_age='30',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='ravi',driver_phonenumber='9541234567',driver_age='21',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='rani',driver_phonenumber='9542754567',driver_age='32',driver_gender='female',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='anusha',driver_phonenumber='956789000',driver_age='25',driver_gender='female',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='ramya',driver_phonenumber='9556789090',driver_age='27',driver_gender='female',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='rajesh',driver_phonenumber='9545678900',driver_age='21',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='sai',driver_phonenumber='9544567890',driver_age='27',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
		driver_details.objects.create(driver_name='siva',driver_phonenumber='9542856799',driver_age='20',driver_gender='male',driver_status='available',vehicle_alloted='prime_car',number='AP27 4770',vehicle_number_id=14)
	...
	if request.method=='POST':
		...
		if(name!='' and room_number!='' and type_vehicle!=None and category_vehicle!=None and number_vehicle!=None and time!='' and driving!=None):
			vehicle_bookings.objects.create(guest_name=name,room_number=room_number,vehicle=type_vehicle,vehicle_type=category_vehicle,vehicle_number=number_vehicle,driver_type=driving,driver_alloted='',time_alloted=time)
		...
		if(name!='' and room_number!='' and type_vehicle!=None and category_vehicle!=None and number_vehicle!=None):
			...
			driver_data=driver_details.objects.filter(number=number_vehicle)
			vehicle_category=[]
			vehicle_number=[]
			driver_name=[]
...
def pick(request):
	return render(request,'traveldesk/pick.html',{})
def driver(request):
